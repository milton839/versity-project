    ...
    if($_FILES['brand_logo']['name']){
        ...
        if(in_array($extension, $allow_file)){
            ...
            if($uploaded_file_size <= 100000){
                ...
                $update_brand = "UPDATE brands SET brand_logo='$new_file_name' WHERE id=$brand_id";
                $update_query = mysqli_query($db_connect, $update_brand);
                $_SESSION['file_added_success'] = "Your file Updated Successfully";
